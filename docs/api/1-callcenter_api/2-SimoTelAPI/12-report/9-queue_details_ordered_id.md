...
<TabItem value="PHP">
	...
	curl_setopt_array($curl, array(
	  CURLOPT_URL => 'http://192.168.51.20//api/v3/reports/queue_details/ordered/id',
...
<TabItem value="JS">
	...
	<html>
			...
			<body>
				<script>
					var settings = {
					  "url": "http://192.168.51.20//api/v3/reports/queue_details/ordered/id",
					  "method": "GET",
					  "timeout": 0,
					  "headers": {
						"X-APIKEY": "9UV0BWKRL83PYIH9Gv1fI85d41lO4S932EeX3wHC47sHjMJOMG",
...
<TabItem value="Linux">
	...
	curl --location --request GET 'http://192.168.51.20//api/v3/reports/queue_details/ordered/id' \
