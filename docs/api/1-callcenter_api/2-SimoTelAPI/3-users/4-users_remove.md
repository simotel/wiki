...
|:---------------------------------------------:|:------------------:|:------------------------:|:----------------------:|:---------:|
| شناسه داخلی که از طریق [سرویس جستجو](/docs/api/callcenter_api/SimoTelAPI/users/users_search) بدست می‌آید |          -         | 6033876dc92de036d1390923 |            **           |    id_    |
...
<TabItem value="Linux">
	...
	curl --location --request DELETE 'http://192.168.51.20/api/v3/pbx/users' \
