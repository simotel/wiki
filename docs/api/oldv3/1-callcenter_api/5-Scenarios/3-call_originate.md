...
برای کسب اطلاعات بیشتر در مورد `Trunk API` به [اینجا](../APIComponents/trunk_api) مراجعه کنید.
...
برای کسب اطلاعات بیشتر در مورد `CDR` به [اینجا](../SimoTelEventAPI/events/cdr) مراجعه کنید.
