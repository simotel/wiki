...
باشد، نام ترانک نیز باید وارد شود. مقدار time_out اختیاری است و در صورت عدم تخصیص به صورت پیش‌فرض 30 ثانیه در نظر گرفته می‌شود.

در خروجی پارامتری به نام originated_call_id برگردانده می شود که معرف تماس دو طرفه ایجاد شده است. 
این پارامتر در گزارشات و سرویس های CDR و event های مرتبط با تماس هم ارسال می گردد.
