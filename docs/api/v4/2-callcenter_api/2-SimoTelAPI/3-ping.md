...
sidebar_position: 1
---
# بررسی ارسال و دریافت درخواست ها 

به منظور بررسی ارسال و دریافت درخواست ها از/به سرور سیموتل خود از این متد استفاده می شود :
...
<TabItem value="Linux">
	...
	curl --location --request POST 'http://192.168.51.20/api/v4/setting/ping/act' \
