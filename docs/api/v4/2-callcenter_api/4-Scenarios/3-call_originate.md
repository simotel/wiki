...
برای کسب اطلاعات بیشتر در مورد `Trunk API` به [اینجا](../SimoTelWebHook/ComponentsApi/trunk_api) مراجعه کنید.
...
برای کسب اطلاعات بیشتر در مورد `CDR` به [اینجا](../SimoTelWebHook/EventsApi/cdr) مراجعه کنید.
