...
|:--------------------------------:|:------------------:|:------------------------:|:----------------------:|:-----------:|
| شناسه‌یکتا که از [جستجو](/docs/developers/api/SimotelAPI/v4/autodialer_api/contact/contact_search) بدست می‌آید |          -         | 60461561095d840c2e477098 |           **           |     id_     |
...
<TabItem value="Linux">
	...
	curl --location --request PUT 'http://192.168.51.21//api/v3/autodialer/contacts' \
