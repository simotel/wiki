...
|:-------------------------------:|:------------------:|:------------------------:|:----------------------:|:---------:|
| شناسه‌یکتا که از [جستجو](/docs/developers/api/SimotelAPI/v4/autodialer_api/contact/contact_search) بدست آمده |          -         | 6033876dc92de036d1390923 |           **           |    id_    |
...
<TabItem value="Linux">
	...
	curl --location --request DELETE 'http://192.168.51.21//api/v3/autodialer/contacts' \
