...
|:-------------------------------------:|:------------------:|:------------------------:|:----------------------:|:---------:|
| شناسه‌یکتا گروه که از [جستجو](/docs/developers/api/SimotelAPI/v4/autodialer_api/group/group_search) بدست می‌آید |          -         | 6033876dc92de036d1390923 |           **           |    id_    |
...
<TabItem value="Linux">
	...
	curl --location --request DELETE 'http://192.168.51.21//api/v3/autodialer/groups' \
