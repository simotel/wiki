...
**۱:** [وب‌سرویس افزودن کمپین](/docs/developers/api/Autodialer_API/campaign/campaign_add)

**۲:** [وب‌سرویس دریافت گزارشات کمپین](/docs/developers/api/Autodialer_API/report/report_search)
