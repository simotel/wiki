 ...
 **۱:** [وب‌سرویس افزودن کمپین](/i18n/en/docusaurus-plugin-content-docs/current/developers/1-api/5-Autodialer_API/4-campaign/1-campaign_add.md)

**۲:** [وب‌سرویس دریافت گزارشات کمپین](/i18n/en/docusaurus-plugin-content-docs/current/developers/1-api/5-Autodialer_API/7-report/1-report_search.md)

**۳:** [وب‌سرویس کامپوننت Exten API](/i18n/en/docusaurus-plugin-content-docs/current/developers/1-api/3-SimotelWebhooks/3-DialplanApiComponents/3-exten_api.md)

**۴:** [وب‌سرویس کامپوننت Trunk API](/i18n/en/docusaurus-plugin-content-docs/current/developers/1-api/3-SimotelWebhooks/3-DialplanApiComponents/4-trunk_api.md)

**۵:** [وب‌سرویس دریافت گزارشات](/i18n/en/docusaurus-plugin-content-docs/current/developers/1-api/2-SimotelAPI/v4/13-report/4-report_cdr_search.md)

**۶:** [وب‌سرویس رویداد CDR](/i18n/en/docusaurus-plugin-content-docs/current/developers/1-api/3-SimotelWebhooks/2-Events/14-cdr.md) 