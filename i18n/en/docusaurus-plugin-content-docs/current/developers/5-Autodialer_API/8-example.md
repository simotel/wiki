...
**۱:**
برای بدست آوردن شناسه‌یکتای فایل صوتی از سرویس [announcement search](/developers/Autodialer_API/announcement/announcement_search) استفاده می‌کنیم، نمونه درخواست  HTTP به شرح زیر می‌باشد
