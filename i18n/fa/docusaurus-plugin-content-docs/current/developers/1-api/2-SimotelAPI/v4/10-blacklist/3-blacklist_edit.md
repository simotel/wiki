...
|:---------------------------------:|:------------------:|:------------------------:|:----------------------:|:---------:|
| شناسه یکتا که از [جستجو](/docs/developers/api/SimotelAPI/v4/blacklist/blacklist_search) بدست می‌آید |          -         | 6033876dc92de036d1390923 |           **           |    id_    |
...
```php
	...
	curl_setopt_array($curl, array(
	  CURLOPT_URL => 'http://192.168.51.20/api/v4/pbx/blacklists/update',
