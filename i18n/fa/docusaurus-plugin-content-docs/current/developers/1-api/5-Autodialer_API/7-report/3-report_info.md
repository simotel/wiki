...
---
<head>
  <title>جزییات گزارشات تماس انبوه | مستندات سیموتل</title>
</head>
...
|:------------------------------------------:|:------------------:|:-------------------------:|:----------------------:|:---------:|
| شناسه یکتای cdr_id که از [جستجو](/docs/developers/api/Autodialer_API/report/report_search) بدست می‌آید |     true/false     | 602e50ce305bdd377168a8c16 |           **           |    _id    |
</div>
