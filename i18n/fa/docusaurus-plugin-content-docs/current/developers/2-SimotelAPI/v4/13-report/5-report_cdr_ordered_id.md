...
این سرویس برای بازیابی اطلاعات جدول جستجوی سریع از ابتدا تا انتها کاربرد دارد، پارامتر ورودی این سرویس id رکوردی است که می‌خواهید اطلاعات بعد از آن بازیابی نمایید، خروجی سرویس رکوردهای جدول به صورت ترتیبی است (در هر فراخوانی 20 رکورد به ترتیب بازگردانده می‌شود).

:::tip نکته
درصورتی که می‌خواهید اطلاعات جدول را از ابتدا بازیابی کنید مقدار پارامتر id_  را برابر با خالی قرار دهید.
:::
