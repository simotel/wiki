---
sidebar_label: "بازیابی ترتیبی جزییات گزارشات صف"
title: "بازیابی ترتیبی جزییات گزارشات صف"
---


# Queue Details Ordered

این سرویس برای بازیابی اطلاعات جدول جزئیات صف از ابتدا تا انتها کاربرد دارد، پارامتر ورودی این سرویس id رکوردی است که می‌خواهید اطلاعات بعد از آن بازیابی نمایید، خروجی سرویس رکوردهای جدول به صورت ترتیبی می‌باشد. (در هر فراخوانی 20 رکورد به ترتیب بازگردانده می‌شود).
...
|-----------------------------------------------------------------|--------------------|--------------------------|-------------------------------|-----------|
| شناسه یکتایی که می‌خواهیم اطلاعات بعد از آن به ترتیب بازیابی شوند (last_id)  |                    | 5ddb9e925171cd0429088bad |                               | id_       |
</div>
