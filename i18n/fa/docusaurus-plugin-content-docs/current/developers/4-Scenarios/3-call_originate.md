...
برای کسب اطلاعات بیشتر در مورد `Trunk API` به [اینجا](/developers/SimotelWebhooks/DialplanApiComponents/trunk_api) مراجعه کنید.
...
برای کسب اطلاعات بیشتر در مورد `CDR` به [اینجا](/developers/SimotelWebhooks/Events/cdr) مراجعه کنید.
...
`CDR` به سمت وب‌ سرویس ارسال می‌شود. برای دانلود فایل از API `reports/quick/cdr` استفاده می‌شود. برای کسب اطلاع بیشتر به [اینجا](/developers/SimotelAPI/v4/report/audio_download) مراجعه فرمایید.
