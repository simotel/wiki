...
**۱:**
برای بدست آوردن شناسه‌یکتای فایل صوتی از سرویس [announcement search](/fa/developers/Autodialer_API/announcement/announcement_search) استفاده می‌کنیم، نمونه درخواست  HTTP به شرح زیر می‌باشد
...
۳،۴،۵: درنهایت نیز باساخت کمپینی با شرایط ذکر شده ارسال تماس انبوه در زمان مشخص شده انجام می‌شود ([campaign add](/developers/Autodialer_API/campaign/campaign_add))، نمونه درخواست HTTP به‌شرح زیر می‌باشد
