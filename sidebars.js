...
// const translations = require('./i18n/en/en2.json');
const translations = {
	en: require('./i18n/en/en2.json'),
	fa: require('./i18n/fa/fa2.json')
  };
const currentLang = process.env.DOCUSAURUS_CURRENT_LOCALE == 'fa' ? 'fa' :'en';
...
module.exports = {
	...
	Docs: [
		...
		{
			type: 'category',
			label: translations[currentLang]['آشنایی با سامانه'],
			collapsed: false,
