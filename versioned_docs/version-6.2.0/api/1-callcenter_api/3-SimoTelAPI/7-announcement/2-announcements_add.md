...
```shell
{
    ...
    "data": {
        ...
        "date": "1399-12-14 07:57:49",
        "_id": "604092fdadafcf23157cb241"
    }
}
```
...
<TabItem value="PHP">
	...
	curl_setopt_array($curl, array(
	  CURLOPT_URL => 'http://192.168.51.20/api/v3/pbx/announcements',
...
<TabItem value="JS">
	...
	<html>
		...
		<body>
			<script>
				var settings = {
				  "url": "http://192.168.51.20/api/v3/pbx/announcements",
				  "method": "POST",
				  "timeout": 0,
				  "headers": {
					"X-APIKEY": "vZKtIKWsld0egNlkzHo8i5LVBqLNBSWARCQsPOSgDjFmAHM3tG",
...
<TabItem value="Linux">
	...
	curl --location --request POST 'http://192.168.51.20/api/v3/pbx/announcements' \
