...
**۳:** [وب‌سرویس کامپوننت Exten API](/docs/api/callcenter_api/APIComponents/exten_api)

**۴:** [وب‌سرویس کامپوننت Trunk API](/docs/api/callcenter_api/APIComponents/trunk_api)

**۵:** [وب‌سرویس دریافت گزارشات](/docs/api/callcenter_api/SimoTelAPI/report/report_cdr_search)

**۶:** [وب‌سرویس رویداد CDR](/docs/api/callcenter_api/SimoTelEventAPI/events/cdr)